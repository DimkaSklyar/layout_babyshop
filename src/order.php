...
Имя: <span style="font-weight:bold;color:#000;">'.$_POST['inputName'].'</span><br> 
Телефон: <span style="font-weight:bold;color:#000;">'.$_POST['inputTel'].'</span><br>
Автомобиль: <span style="font-weight:bold;color:#000;">'.$_POST['inputCar'].'</span><br>'; 
